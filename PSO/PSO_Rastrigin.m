function PSO_Rastrigin(n_dim, n_agents)
%% User defined parameters
m = n_dim;                    % dimensionality (search space) for m = 2 or m = 3
n_particles = n_agents;       % numbers of particles (agents) set for 10 or 20
